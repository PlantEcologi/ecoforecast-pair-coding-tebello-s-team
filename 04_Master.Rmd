...
>*Answer 1: It is because no new plants are growing. If it were increasing linearly through time, it would mean new greenness is being introduced, however, in this case the same type of greenness is being recorded.*
...
>*Answer 2: the estimates of the common parameters in model 2, except for the gamma parameter, are smaller than model 2.*
...
>*Answer 3: Model 2. the residual sum is squares is significantly smaller than that of Model 1. Therefore, Model 2 explains more variation than Model 1.The p-value <0.05 and therefore, Model 2 is significantly more fit for the data than Model 1*

Q4: How many degrees of freedom are there in this ANOVA and why (i.e. what are they)?

>*Answer 4: there are 2 degrees of freedom. The anova is comparing 2 models with different numbers of parameters. Therefore, Model 2 has two more parameters than Model 1. Because of this, the residual degrees of freedom for the 2 model, is 2 less than that of model 1*
...
>*Answer 5:the full model is preferred. The full model has a smaller AIC relative to the simple model. The difference is greater than 3, therefore, the models are significantly different from one another.*
...
>*Answer 6:The MLE models have their log-likelihood maximised while the NLS do not. This means that the data being compared is not on the same scale for comparison to be valid.*
